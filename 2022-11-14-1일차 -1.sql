...
CREATE TABLE itemTBL (
    id NUMBER(4), -- 상품 아이디 : 001, 002,...
    buyer NUMBER, -- 구매자 이름 : 1-홍길동, 2-김길동,...
    title VARCHAR2(100), -- 상품명 : 100바이트
    qty NUMBER, -- 상품 갯수
    price VARCHAR2(50), -- 상품 가격
    sell_date VARCHAR2, -- 판매일
);

-- NUMBER : 숫자 타입/소수점
-- CHAR : 고정 문자 (ex.주민번호)
-- VARCHAR2 : 가변 문자 vs VARCHAR : 오라클에서 다시 어떤 목작으로 재사용하기 위해 가급적으로 사용하지 않도록!
-- NCHAR, NVARCHAR : National (다국어, 영어가 아닌 한국어 등의 외국어... 각 나라별 언어 설정)
-- DATE : (시간)날짜 vs TIMEZONE, TOMESTAMP : 밀리세컨드까지 저장 (ex. 출입기록)
