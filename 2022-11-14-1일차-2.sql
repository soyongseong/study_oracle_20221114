...
INSERT INTO itemTBL
VALUES (0001, 1, '따끈따끈 군고구마 1박스', 100, 15000, TO_DATE('2022/10/15'));
INSERT INTO itemTBL
VALUES (0002, 2, '온열 손난로', 10, 20000, TO_DATE('2022/10/20'));
INSERT INTO itemTBL
VALUES (0003, 3, '캠핑은 먹는 재미지, 이베리코 삼겹살', 100, 15000, TO_DATE('2022/11/15'));
